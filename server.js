                              ...
                              <table width="100%" cellpadding="0" cellspacing="0" role="presentation">
                                <tr>
                                  <td align="center"
                                    ...
                                    <h2
                                      style="Margin:0;font-family:'Inter', sans-serif;font-size:20px;font-weight:600;color:#111827;padding-top:20px">
                                      Share &amp; get rewards</h2>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center"
                                    style="padding:0;Margin:0;padding-bottom:16px;padding-left:20px;padding-right:20px">
                                    <p
                                      style="Margin:0;font-family:'Inter', sans-serif;font-size:15px;line-height:22px;color:#4B5563">
                                      Invite friends to unlock bonuses and early platform access.</p>
                                  </td>
                                </tr>
                                <tr>
                                  <td align="center"
                                    style="padding:0;Margin:0;padding-bottom:30px;padding-left:20px;padding-right:20px">
                                    <p style="Margin:0;font-family:'Inter', sans-serif;font-size:14px;color:#6B7280">
                                      Your referral link:</p>
                                    <p
                                      style="Margin:0;Margin-top:8px;font-family:ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, monospace;font-size:15px;color:#4F46E5;background-color:#EEF2FF;padding:10px 16px;border-radius:8px;display:inline-block;-webkit-user-select:all;user-select:all;cursor:text">
                                      ${referralUrl}</p>
                                  </td>
                                </tr>
                              </table>
